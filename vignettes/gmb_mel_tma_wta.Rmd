...
bgquants <- function(x, xbg, bw.adjust=3, n=10000, eps=1e-10) {
...
st_geomx_bgcorrect <- function(x, bg, theta=0.25, bw.adjust=3, n=10000, eps=1e-10, min.count=1) {
...
x <- st_geomx_bgcorrect(ds$counts, ds$meta$bg, theta=0.25, bw.adjust=5, n=10000, eps=1e-20)

apply(x, 2, function(x) { any(is.na(x))})

p1 <- plot_bgsub(ds$samples, ds$meta, x, cpm_quantile=1)
p1
