...
plot_bgcorrect_helper <- function(ds, title, quantiles=c(0.10, 0.25, 0.5, 0.75, 0.90, 0.95, 0.99)) {
...
plot_bgsub_qn <- plot_bgcorrect_helper(fds_bgsub_qn, "bgsub + qn")
plot_bgsub_rle <- plot_bgcorrect_helper(fds_bgsub_rle, "bgsub + rle")
plot_bgsub_q3 <- plot_bgcorrect_helper(fds_bgsub_q3, "bgsub + q3")
plot_bgsub_tmm <- plot_bgcorrect_helper(fds_bgsub_tmm, "bgsub + tmm")

plot_qq_qn <- plot_bgcorrect_helper(fds_qq_qn, "qq + qn")
plot_qq_rle <- plot_bgcorrect_helper(fds_qq_rle, "qq + rle")
plot_qq_q3 <- plot_bgcorrect_helper(fds_qq_q3, "qq + q3")
plot_qq_tmm <- plot_bgcorrect_helper(fds_qq_tmm, "qq + tmm")

plot_none_qn <- plot_bgcorrect_helper(fds_none_qn, "none + qn")
plot_none_rle <- plot_bgcorrect_helper(fds_none_rle, "none + rle")
plot_none_q3 <- plot_bgcorrect_helper(fds_none_q3, "none + q3")
plot_none_tmm <- plot_bgcorrect_helper(fds_none_tmm, "none + tmm")
...
# PCA
pca_none_q3 <- pca(s_none_q3, y_none_q3)
pca_none_tmm <- pca(s_none_tmm, y_none_tmm)
pca_none_rle <- pca(s_none_rle, y_none_rle)
pca_none_qn <- pca(s_none_qn, y_none_qn)

pca_bgsub_q3 <- pca(s_bgsub_q3, y_bgsub_q3)
pca_bgsub_tmm <- pca(s_bgsub_tmm, y_bgsub_tmm)
pca_bgsub_rle <- pca(s_bgsub_rle, y_bgsub_rle)
pca_bgsub_qn <- pca(s_bgsub_qn, y_bgsub_qn)

pca_qq_q3 <- pca(s_qq_q3, y_qq_q3)
pca_qq_tmm <- pca(s_qq_tmm, y_qq_tmm)
pca_qq_rle <- pca(s_qq_rle, y_qq_rle)
pca_qq_qn <- pca(s_qq_qn, y_qq_qn)
